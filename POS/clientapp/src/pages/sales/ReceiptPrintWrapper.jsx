...
const ReceiptPrintWrapper = () => {
    ...
    const gotoCart = () => {
        dispatch(setDrawerComponent({ DrawerComponentChild: CartPage, drawerOpen: true }));
    };
    ...
    return (
        <>
            ...
            >
                ...
                <DialogContent sx={{ px: 2, display: 'flex', flexDirection: 'column', gap: 2 }}>
                    ...
                    <Box
                        sx={{
                            ...
                            alignItems: { xs: "center", sm: "flex-end" }, // center on mobile, left on desktop
                        }}
                    >
                        ...
                        {paymentModeError && (
                            <Typography
                                variant="caption"
                                color="error"
                                sx={{ textAlign: { xs: "center", sm: "left" }, mt: 0.5 }}
                            >
                                {paymentModeError}
                            </Typography>
                        )}
